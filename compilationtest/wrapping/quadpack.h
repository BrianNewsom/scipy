...
class function {
  ...
  public:
    ...
    void eval();
    void arrayEval( float(*fnArray123)(float xes[], int *nx, float ts[], int *nt));
};
...
void function::arrayEval( float(*fnArray)(float xes[], int *nx, float ts[], int *nt)){
